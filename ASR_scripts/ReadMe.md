...
|-----    |-----|------   |-----                           |
|   v3    | 01/20/2022 | <li> Now support restoring Chrome and Edge per profile pinned taskbar shortcuts.  For instructions, please see the v2 details below. </li>|https://aka.ms/ASRTaskBarRepairTool|
